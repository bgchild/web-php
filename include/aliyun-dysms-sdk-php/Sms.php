...
require_once dirname(__DIR__) . '/aliyun-dysms-sdk-php/api_sdk/vendor/autoload.php';
...
class Sms {
    ...
    public static function getAcsClient() {
        ...
        //$accessKeyId = "LTAILuCmFOUrTH46"; // AccessKeyId
        //$accessKeySecret = "VNvKjBipx4OdA3i8e7xzfIls5iWP9p"; // AccessKeySecret
