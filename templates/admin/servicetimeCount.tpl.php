...
<div class="service_top">
   ...
   <?php }?>
                        ...
                        <td align="right" colspan="2">
							...
							<a href="servicetimeCount.php" class="btn" role="button"><span class="add"></span>重置</a>
						</td>
                    ...
                    <!--<tr>
                        ...
                        <td width="140">
							<input type="text" class="input" name="team" value="<?php /*echo $infos['team']*/?>"/>
						</td>
						<td colspan="3">
							<input type="button"  class="btn" value="检索" onclick="checkteam()"/>
							<div id="hid_rel"></div>
						</td>
...
<div class="tabContent">
	...
	<table class="list-table" cellspacing="1" cellpadding="2">
		<tr>
			...
			<th align="center" width="50%">服务队</th>
			<th align="center" width="25%">工时数（小时）</th>
		</tr>
		<?php $num_team = 0; $num=0; foreach($counts as $v){?>
			<tr>
				<td align="left"  class="omit1"><a style="text-decoration:none;"><?php echo $v['organ'];?></a></td>
				<td align="center" class="omit2"><?php echo $v['num_team'];?></td>
				<td align="center" class="omit2"><?php echo $v['num'];?></td>
			</tr>
			<?php $num_team += $v['num_team']; $num+=$v['num']; } if(!$counts){ ?>
			<tr>
		...
		<div style="width: 2000px;">
			<table class="list-table" cellspacing="1" cellpadding="2">
				<tr>
					...
					<th align="center" width="20%">工时数（小时）</th>-->
					<?php /*$num = array(); */?>
