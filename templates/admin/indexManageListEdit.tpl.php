...
<form action='indexManageList.php' method='post' class="searchFrom">
   			<table class="base_table">
    			<tbody>
    				<tr>
    					<th><span style="color: red;">*&nbsp;</span>栏目：</th><td colspan="4"><input readonly="readonly" type="text" style="height:30px;" name="name"  value="<?php echo $column['name'];?>" class="input length_5"/></td>
    				</tr>
    				<tr>
    					<th><span style="color: red;">*&nbsp;</span>标题：</th><td colspan="4"><input type="text" name="title"  style="height:30px;"id="title"  maxlength="26" value="<?php echo $detail['title'];?>" class="input length_5"/></td>
    				</tr>
    				<tr>
    					<th>缩略图：</th><td colspan="3"><div class="thumb"><?php if($detail['pictures']){?> <img src="<?php echo $detail['pictures']?>" > <?php }else{ echo "生成160px*120px缩略图";} ?></div></td><td><input type="button" id="uploadButton" value="上传图片"  /></td>
    				</tr>
    				<tr>
    				...
    				<td ></td>
	    					...
	    					<td><input type="submit"  name="save"  class="btn"  id="save" value="保存" />&nbsp;&nbsp;&nbsp;<a href="indexManage.php" class="btn">返回</a></td>
    				<?php }else{?>
    				     <td></td>
    					...
    					<td><input type="submit"  name="save"  id="save" class="btn" value="保存" />&nbsp;&nbsp;&nbsp;<a href="<?php echo $backurl;?>" class="btn">返回</a></td>
    				<?php }?>
    				</tr>
    	 		</tbody>
    			</table>
