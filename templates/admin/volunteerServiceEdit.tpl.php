...
<form action='volunteerService.php' method='post' class="searchFrom">
   			<table class="base_table" style="padding:0px;">
    			<tbody>
    				<tr>
    					<th>栏目名称：</th><td><input type="text" name="name"  id="name"  maxlength="26" value="<?php echo $detail['name'];?>" class="input length_4"/></td>
    				</tr>	
    	 		</tbody>
    			</table>
    			<div style="margin-top:20px;margin-left:69px;">
    				...
    				<a style="margin-left:15px;" href="volunteerService.php" class="btn">返回</a>
    			</div>
</form>
</div>
