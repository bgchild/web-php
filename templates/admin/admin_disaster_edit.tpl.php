    ...
    <div class="con">
        ...
        <div class="admin_right">
            ...
            <div style="margin-left:20px;">
                <form action='adminDisasterList.php' method='post' class="searchFrom">
                    <table class="base_table">
                        ...
                        <tr>
                            ...
                            <td colspan="4"><?php echo $info['cate_name']; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4"><?php echo $info['victims_num']; ?>人</td>
                        </tr>

                        <tr>
                            <th width="125">受伤人数：</th>
                            <td colspan="4"><?php echo $info['injured_num']; ?>人</td>
                        </tr>

                        <tr>
                            <th width="125">失踪人数：</th>
                            <td colspan="4"><?php echo $info['missing_num']; ?>人</td>
                        </tr>

                        <tr>
                            <th width="125">死亡人数：</th>
                            <td colspan="4"><?php echo $info['die_num']; ?>人</td>
                        </tr>

                        <tr>
                            <th width="125">受紧急转移安置人口：</th>
                            <td colspan="4"><?php echo $info['transfer_num']; ?>人</td>
                        </tr>

                        <tr>
                            <th width="125">需口粮救济人口：</th>
                            <td colspan="4"><?php echo $info['food_help_num']; ?>人</td>
                        </tr>

                        <tr>
                            <th width="125">损坏耕地面积：</th>
                            <td colspan="4"><?php echo $info['damage_land']; ?>公顷</td>
                        </tr>

                        <tr>
                            <th width="125">农作物/草场受灾面积：</th>
                            <td colspan="4"><?php echo $info['damage_crops']; ?>公顷</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <select name="status" id="status">
                                    <option value="0" <?php if($info['status']==0){ echo "selected";}?>>未处理</option>
                                    <option value="1" <?php if($info['status']==1){ echo "selected";}?>>处理中</option>
                                    <option value="2" <?php if($info['status']==2){ echo "selected";}?>>已处理</option>
                                </select>
                            </td>
                        </tr>
