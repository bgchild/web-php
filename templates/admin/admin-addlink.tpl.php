...
<div id="content">
    <div class="con">
        ...
        <div class="admin_right">
            ...
            <div class="upflash">
                <form action="adminaddlink.php" method="post" enctype="multipart/form-data" id="addlink">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><div class="thumb"><?php if($one['img']){?> <img src="../<?php echo $one['img']?>" > <?php }else{ echo "建议上传155px*65px图片(2M以内)";} ?></div></td><td><?php if($now_flag){?><input type="button" id="uploadButton" value="上传图片"  /><?php }?></td></tr>
                        <input type="hidden" id="thumb_url" name="thumb_url" value="<?php if($one['img']) {echo "../".$one['img']; }?>"  />
                    </table>
                    <div class="save">
                        <?php if($now_flag){?><input type="submit" class="addbtn" name="dosave" value="保存"/><?php }?><a href="adminlink.php"><div class="addbtn returnbtn">返回</div></a></div>
                </form>
...
<script type="text/javascript">
    KindEditor.ready(function(K) {
        var uploadbutton = K.uploadbutton({
            ...
            fieldName : 'imgFile',
            url : '../link_thumb.php?&time='+new Date().getTime(),
