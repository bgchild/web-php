...
<div class="adminflash">
	<?php if($now_flag) {?><a href="adminuser.php" class="addbtn btn_alone" role="button"><span class="add"></span>添加管理员</a><?php }?>
    <form action="" method="post" id="orderlist">
    	<table class="list-table" cellspacing="1" cellpadding="2">
            ...
            <tr>
                ...
                <?php if($now_flag) {?><td align="center"><a href="adminuser.php?spm=<?php echo set_url($v['recordid']);?>"><img src="../templates/images/manage/icon_edit.gif"/></a>
                <?php if ($v['def']!='1'){?><a href="javascript:if(confirm('确定删除么?')) location.href='adminuserlist.php?deleteid=<?php echo set_url($v['recordid']);?>' " class="del" ><img src="../templates/images/manage/icon_drop.gif"/></a><?php }?></td><?php }?>
            </tr> 
            <?php } ?>
        </table>
    </form>
