        ...
        <div class="content_right">
            ...
            <div class="con_right_bottom">
                ...
                <div class="service_top">
                    <form action='userTrainManage.php' method="post" class="searchFrom" id="myform">
                        <fieldset class="searchFieldSet">
                            ...
                            <table class="base_table">
                                ...
                                <tr>
                                    <th>&nbsp;&nbsp;&nbsp;&nbsp;培训队员：</th>
                                    <td><input type="text" name="trainer"  value="<?php echo $info['trainer'];?>" class="input length_2"/></td>
                                    <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;培训日期：</th>
                                    ...
                                    <td><input type="submit" name="doSearch" class="btn" value="查询" />&nbsp;&nbsp;<a href="userTrainManage.php" class="btn" role="button"><span class="add"></span>重置</a></td>
                                </tr>
                                </tbody>
                            </table>
                        </fieldset>
                ...
                <a href="userTrainSaveAdd.php" class="addbtn btn_alone" role="button"><span class="add"></span>新建</a>
                <div class="service_middle">
                    <div class="tabContent">
                        <table class="list-table" cellspacing="1" cellpadding="2">
                            <tr>
                                <th align="center">培训队员</th>
                            ...
                            <?php 	foreach ($trains as $k=>$v){ ?>
                                <tr>
                                    <td align="left" width="74px" class="tdprizewinner">
                                        <a style="cursor: pointer;" title="<?php echo $v['trainer'];?>"><?php echo $v['trainer'];?></a></td>
                                    ...
                                    <td align="center" width="45px">
                                        <a href="userTrainSaveAdd.php?recordid=<?php echo set_url($v['recordID']);?>">
                                            <img src="../templates/images/manage/icon_edit.gif" alt="修改"/>
                                        </a>
                                    </td>
                                </tr>
                            <?php } if(!$trains){ ?>
