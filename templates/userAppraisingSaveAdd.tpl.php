                ...
                <div class="service_top" style="margin-top: 30px;">
                    <form action="" method="post" name="myform" id="myform">
                        <table class="server_tab">
                            <tr>
                                <td width="90" align="right"><span style="color: red;">*&nbsp;</span>获奖人：</td>
                            ...
                            <tr>
                                <td width="90" align="right"><span style="color: red;">*&nbsp;</span>获奖日期：</td>
                            ...
                            <tr>
                                <td width="90" align="right"><span style="color: red;">*&nbsp;</span>获奖地点：</td>
                            ...
                            <tr>
                                <td width="90" align="right"><span style="color: red;">*&nbsp;</span>获奖内容：</td>
                        ...
                        <div class="btn-group">
                            <?php if(!$myaward){		?>
                                ...
                                <a href="userAppraisingManage.php" class="btn doreset" >返回</a>
                            <?php }else{?>
